...
While developing *jig* we discovered some best practices around writing a generic Go library. There is an effective way of structuring it and we'll introduce that here. Let's look at an example library `github.com/reactivego/generics/example/stack`. It's located in our *jig* repository on GitHub.

```
$GOPATH/src/github.com/reactivego/generics/example/stack
                                                   └── generic
                                                       └── test
                                                           ├── Pop
                                                           ├── Push
...
The information provide by these three pragmas is enough for jig to work with. This simple stack is on github as part of the jig example code. To use it `import _ "github.com/reactivego/generics/example/stack/generic"`.
...
```
> *NOTE*
> - We're importing `github.com/reactivego/generics/example/stack/generic` only so jig can access it.
